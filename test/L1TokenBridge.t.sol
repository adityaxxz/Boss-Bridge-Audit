...
contract L1BossBridgeTest is Test {
    ...
    Account operator = makeAccount("operator"); // operator.key & operator.add
    ...
    // test for depositTokensToL2() - if a user approves the bridge, any other user can steal their funds.
